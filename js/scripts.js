$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Nicoel and Jim's Wedding",

            // Event start date
            start: new Date('Jul, 2022 17:30'),
            ...
            end: new Date('Jul, 2023 00:00'),

            // Event Address
            address: 'Cleveland Botanical Gardens, Cleveland OH',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '6079d2b040d376d599ef90a30effe95f' {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxqmf58-ctsaKDqIY_zYMD2unEIjpCIrLT9zsIWMtly1WgBbKjXk86nag2KvyCjoUohBw/exec, data)
                .done(function (data) {
                    console.log(data);
